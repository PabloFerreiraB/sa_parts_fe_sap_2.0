...
export class SidenavService {
  ...
  public isSlidingInFromRight = false;

  public isSlidingInFromLeft = false;

  public get sidenavTransitionDuration(): number {
  ...
  public setDynamicContentArea(host: SidenavContentAreaDirective) {
    this.#contentArea = host;
  }

  public async push(component: Component<unknown>): Promise<void> {
